...
return [
    ...
    */
    'managers' => [
        'default' => [
            ...
            'namespaces' => [],
            'paths' => [
                base_path('vendor/rela589n/doctrine-event-sourcing/config/mappings'),
                app_path('Models/User/mappings'),
                app_path('Models/Chat/mappings'),
                app_path('Models/Message/mappings'),
            ],
    ...
    */
    'custom_types' => [
        ...
        'json_document' => JsonDocumentType::class,
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'logger' => env('DOCTRINE_LOGGER', LaravelDoctrine\ORM\Loggers\LaravelDebugbarLogger::class),
    /*
    |--------------------------------------------------------------------------
    | Cache
    |--------------------------------------------------------------------------
